...
#' Problem environments with 
#' real test functions for simple genetic algorithms
#' 
#' The \code{envRealFunctions} package implements
#' for example the functions F1-F5 of Kenneth De Jong's Thesis.
#'
...
#'   \enumerate{
#'    \item A set of 2-D parabola functions in DelayedP.R for testing:
#'          With time delays, with random errors, and early termination.
#'    \item De Jong's functions (F1-F5).
#'    \item Multimodal 2-D sine waves (AGSF7d1, F6, F6inv, and F7).
#'    \item Functions A1-A30 from Lavezzi et al. (2022).
...
#'  URL: https://cs.gmu.edu/~eclab/kdj_thesis.html 
#'
#' Lavezzi, Giovanni and Guye, Kidus and Ciarcia, Marco (2022):
#' Nonlinear Programming Solvers for Unconstrained and Constrained
#' Optimization Problems: a Benchmark Analysis. 
#' arXiv, arXiv:2204.05297v1 (11 April 2022).
#' 
#' Bossek, Jakob (2017)
#'          smoof: Single- and Multi-Objective Optimization Test Functions.
#'           The R Journal, 9(1), 103-113.
#'
#' @name envRealFunctions
#' @aliases envRealFunctions
#' @title Package Problem Environments for Real Functions
