...
%\usecolortheme[colors={ao, babyblueeyes, bleudefrance, blue, cobalt, 
%                       darkmidnightblue, brandeisblue, deepskyblue},
%auto=section]{rainbow}
%\AtBeginDocument{
%  \setcounter{rainbow@count}{1}
%  \rainbow
%}
\setbeamercolor{structure}{fg=darkpastelgreen}
%\setbeamercolor{titlelike}{bg=ultramarine}
%\setbeamercolor{separation line}{bg=darkmidnightblue}
%\setbeamercolor{mini frames}{use=darkmidnightblue}
%\setbeamercolor{mini frame}{bg=cobalt}
...
\end{block}
\end{frame}% report/ExpCmain040.tex
\clearpage
\section{A Summary}
